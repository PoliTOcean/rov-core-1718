...
//comment the following row to avoid debugging messages
#define DEBUG 1
...
#define GYRO_SENS PI/1900.0   // gyroscope sensitivity
#define dt 0.02               // IMU timer timeout in seconds  (20ms)
#define dST 0.2                 // serial timer timeout in seconds  (2")
...
#define FAST_H 100            // front-back turbo
